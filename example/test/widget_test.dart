...
import 'package:secure_print_example/main.dart'; // Adjust this import to your actual example file path
...
void main() {
  ...
  group('MyApp', () {
    ...
    testWidgets('handles print PDF button press', (WidgetTester tester) async {
      ...
      when(mockPlatform.getAvailablePrinters())
          .thenAnswer((_) async => mockPrinters);
      when(mockPlatform.printPdf(pdfData, printerName)).thenAnswer((_) async {
        return;
      });
      ...
      // Verify printPdf method was called
      verify(mockPlatform.printPdf(pdfData, printerName)).called(1);
    });
  });
}

// Mock class for SecurePrintPlatform
